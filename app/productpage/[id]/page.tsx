  ...
  return (
    <>
      ...
      <div className="relative">
          ...
          <h2 className="font-extrabold tracking-wider text-2xl">Product Information</h2>
        </div>
      </div>
      <div className="grid grid-cols-3">
        <h1 className=" cols-span-1 text-xl font-semibold opacity-70">PRODUCT DETAILS</h1>
      ...
      <div className="grid grid-cols-3 mt-8">
        <h1 className=" cols-span-1 text-xl font-semibold opacity-70">PRODUCT CARE</h1>
